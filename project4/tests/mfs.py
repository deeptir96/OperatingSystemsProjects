...
#      raise Failure("Could not start server")
   ...
   def creat(self, inum, type, name):
      ...
      self.log("creat: r = "+str(r) + " inum = "+str(inum) + " type = "+str(type))
      #if r != 0:
